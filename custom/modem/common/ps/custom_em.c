 ...
 * [MOLY00052621] [CMCC Case][国际漫游][MT6592]Externel (EE),0,0,99,/data/core/,1,modem,md1:[Fatal error (task)] err_code1:773 err_code2:-2004352967
 * .
 *
 * 12 28 2013 vend_bob.chiang
 * [MOLY00051916] 【G750-T00】读写IMEI号失败（跟ALPS01209771 现象不一样）
 * .
 *
