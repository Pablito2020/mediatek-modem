...
{
   #if defined (__NVRAM_CUST_PACK_DL7M_UL5M__)
	 {8, 6}
   #elif defined (__NVRAM_CUST_PACK_DL14M_UL5M__)
   {10, 6} 
   #elif defined(__NVRAM_CUST_PACK_DL14M_UL11M__)
   {10, 7}
   #elif defined(__NVRAM_CUST_PACK_DL21M_UL5M__)
   {14, 6}
   #elif defined(__NVRAM_CUST_PACK_DL21M_UL11M__)
   {14, 7}
   #elif defined(__NVRAM_CUST_PACK_DL42M_UL5M__)
   {24, 6}
   #elif defined(__NVRAM_CUST_PACK_DL42M_UL11M__)
   {24, 7}
   #else
   {24, 7} /* DEFAULT */
   #endif
