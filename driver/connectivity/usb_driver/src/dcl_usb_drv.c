...
static DCL_STATUS DCL_USB_CTRL_API_USB_DMA_Setup(DCL_CTRL_DATA_T *data)
{
  ...
  #if defined(MT6589) && defined(__MD1__) /* USB in AP side, and bank addr is 0x80000000*/
    addr = (kal_uint32)prdma_setup_func->u4addr | 0x80000000;;
  #elif defined(MT6589) && defined(__MD2__)  /*USB in AP side, bank addr is 0x80000000*/
    addr = (kal_uint32)prdma_setup_func->u4addr | 0x80000000;
  #elif defined(MT6572) || defined(MT6582) || defined(MT6571) || defined(MT6592) /*USB in AP side, bank addr is 0x80000000*/
    addr = (kal_uint32)prdma_setup_func->u4addr | 0x80000000;    
  #else
