...
__DOR_TCM_LOCAL_FUNC__ void dormant_mode_activate(void)
{
...
#if defined(MT6575) || defined(MT6577) || defined(MT6280) || (defined(MT6589) && defined(__MD1__)) || defined (MT6572) || defined (MT6582) || defined (MT6592) || defined (MT6571)

    #if (defined(MT6589) && defined(__MD1__)) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571)
    ...
    *BOOT_VECTOR_ENABLE = BOOT_VECTOR_ENABLE_VAL;
    #else //#if (defined(MT6589) && defined(__MD1__)) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571)
    orig_reset = *DORMANT_BOOT_JUMP_ADDR;
    *DORMANT_BOOT_JUMP_ADDR = (unsigned int)arm_dormant_reset_handler | BOOT_VECTOR_ENABLE;
    #endif //    #if (defined(MT6589) && defined(__MD1__)) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571)
