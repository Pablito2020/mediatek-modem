...
kal_int32 ccci_excep_dbg_logging(kal_uint32 index, void* addr)
{
    ...
    if (addr == NULL || ((kal_uint32)addr % 4 !=0) || index >= CCCI_EXCEP_DBG_LOG_INDEX_MAX || ccci_excep_dbg_log_base == NULL)
        return CCCI_FAIL;
...
kal_int32 ccci_excep_dbg_logging_InHS2(kal_uint32 index, void* addr)
{
    ...
    if (addr == NULL || ((kal_uint32)addr % 4 !=0) || index >= CCCI_EXCEP_DBG_HS_LOG_MAX || ccci_excep_dbg_log_base_hs2 == NULL)
        return CCCI_FAIL;
