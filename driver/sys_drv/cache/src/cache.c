...
#endif /* __MTK_MMU__ */
#include "emi_sw.h"     /* for sram repair */
...
__attribute__((section("NONCACHED_NONBUFFERED_RW"))) volatile kal_uint32 dummy_ncnb[1024*4/4] = {0};    /* NCNB for Data Memory Barrier */
#endif /* __ARM9_MMU__ */
...
/* dummy NCNB initialize */
#if defined(__ARM9_MMU__)
    dummy_ncnb[0] = 0x4E434E42;
#endif /* __ARM9_MMU__ */
...
#elif defined(__MTK_TARGET__) && defined(__CR4__)
{
    return 0;
}
#else
...
#if defined(__MTK_TARGET__) && (defined(__ARM9_MMU__) || defined(__ARM11_MMU__) || defined(__MTK_MMU__) || defined(__CR4__))
#if defined(__MTK_MMU__) || defined(__CR4__)
{
    return 0;
}
#else /* __MTK_MMU__ */
...
/*************************************************************************
* FUNCTION
*  cache_intsram_repair
*
* DESCRIPTION
*  This function used to invoke sram repair machanism.
*
* CALLS
...
*
*************************************************************************/
void cache_intsram_repair(void)
{
#if defined(MT6572) || defined(MT6571)
    if((*((volatile kal_uint32*)0xA0009170) >> 21) & 0x1) {
        if(SRAM_repair(MDSYS) != 0) {
            while(1);   //ASSERT() is not available yet
        }
    }
#endif
...
#endif /* __MTK_TARGET__ */
__attribute__ ((aligned(32))) kal_uint32 CDST_DCDNC_array[64*1024];
