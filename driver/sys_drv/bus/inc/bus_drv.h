...
/* under construction !*/
    #if (defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571)) && !defined(__SWLA_EBM_ADDON_SUPPORT__)
/* under construction !*/
/* under construction !*/
/* under construction !*/
    #endif
...
// Control EMI High priority
    ...
    #endif
#elif defined(MT6572) || defined(MT6571)
    // do nothing
    #define BUS_MCU2EMI_ULTRA_SET()
    #define BUS_MCU2EMI_ULTRA_CLR()
...
#elif defined(MT6571) && defined(__GL1_SW_PROFILE_ELM__)
    #define BUS_CTIRQ_PROFILE_ELM_START() \
        do {\
            extern kal_uint32 elm_history_idx; \
            extern CTIRQ_ELM_PROFILE_T elm_history[64]; \
