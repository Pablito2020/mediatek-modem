...
#if (defined (MT6589) && !defined (__MD2__)) || defined (MT6572) || defined (MT6582) || defined (MT6592) || defined (MT6571)
void DCM_Recovery(void)  __SECTION__(INTSRAM_ROCODE);
#endif //#if (defined (MT6589) && !defined (__MD2__)) || defined (MT6572) || defined (MT6592) || defined (MT6571)
...
void Leave_DCM_mode(void)
{
    ...
    *DCM_RG_CK_DCM_DSP_EN = 0x0; //DSP, bus, DCM disable
    ...
    #elif defined(MT6589) || defined(MT6572) || defined(MT6592) || defined (MT6571)
	_dcm_hw_setting(0);
...
#endif //#if defined(MT6572) || defined (MT6582) || defined (MT6592) || defined (MT6571)
