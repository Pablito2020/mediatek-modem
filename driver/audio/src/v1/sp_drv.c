...
#if (!SMART_PHONE_HW_SIDETONE_SUPPORT) // using software sidetone
...
#if defined(MT6280) || defined(MT6589) || defined(MT6572) || defined(MT6582) || defined(MT6592) || defined(MT6571)// hw did not support
		ASSERT(0);
#else 
