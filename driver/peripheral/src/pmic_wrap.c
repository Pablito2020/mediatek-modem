...
#elif defined(DRV_PMIC_WRAP_6572_REG) || defined(DRV_PMIC_WRAP_6582_REG) ||  defined(DRV_PMIC_WRAP_6571_REG)
...
//    kal_uint32 start_time_ns = 0, timeout_ns = 0;
    ...
    pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].start_time = ust_get_current_time_start;
    pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].pmu_time_start = tqcnt1;
    pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].gpt3_time_start = gpt3_start;
    pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].gpt4_time_start = gpt4_start;
    pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_start = saved_current_time_start;
    pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_start1 = saved_current_time_start1;    
    pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_start2 = saved_current_time_start2;    
#endif
    ...
    */
...
#if defined(DCL_PMIC_ACCESS_TIME_LOG)
    pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_action1 = drv_get_current_time();
#endif

    PMIC_WRAP_DRV_WriteReg32(PMIC_WRAP_SIG_VALUE, PMIC_PATTERN_VAL);
    
#if defined(DCL_PMIC_ACCESS_TIME_LOG)
    pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_action2 = drv_get_current_time();
#endif
    ...
    do
    {
...
#if defined(DCL_PMIC_ACCESS_TIME_LOG)        
        pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_action3 = drv_get_current_time();
        ...
        pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_action4 = drv_get_current_time();        
#endif        
...
#if defined(DCL_PMIC_ACCESS_TIME_LOG)        
        pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_action5 = drv_get_current_time();        
#endif
        ...
        {
#if defined(DCL_PMIC_ACCESS_TIME_LOG)
            pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].end_time = ust_get_current_time();
...
#endif            
            pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].pmu_time_end = tqcnt2;
            pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].gpt3_time_end = gpt3_end;   
            pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].gpt4_time_end = gpt4_end;            
            GET_DURATION(duration, tqcnt1, tqcnt2); // Get duration time between start and end time
            pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].pmu_time_duration = duration;
            TRANS_TO_QBIT(duration, duration);  // Time unit transfer            
            pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].pmu_time_qbit = duration;
            pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_end = saved_current_time_end;
            pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_end1 = saved_current_time_end1;
            pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].drv_get_current_time_end2 = saved_current_time_end2;
            pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].duration_time = \
                ust_get_duration(pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].start_time, pmic_access_duration_log[PMIC_WRAPPER_DBG][pmic_access_duration_index].end_time);    
#endif            
#if defined(PMIC_WRAP_MEMORY_DUMP_SUPPORT)
            pmic_wrap_memory_dump();
#endif
...
kal_uint32 DrvPWRAP_Init(void)
{
    ...
    kal_uint32 rdata;
#if defined(DRV_PMIC_WRAP_6572_REG) || defined(DRV_PMIC_WRAP_6571_REG)
    kal_uint32 cg_mask;
    kal_uint32 backup1;
#endif
...
#if defined(DCL_PMIC_ACCESS_TIME_LOG)
    pmic_access_duration_log[PMIC_WRAPPER_WACS0_WRITE_DBG][pmic_access_duration_index].start_time = ust_get_current_time();
#endif
...
#if defined(DCL_PMIC_ACCESS_TIME_LOG)
    pmic_access_duration_log[PMIC_WRAPPER_WACS0_WRITE_DBG][pmic_access_duration_index].end_time = ust_get_current_time();
    pmic_access_duration_log[PMIC_WRAPPER_WACS0_WRITE_DBG][pmic_access_duration_index].duration_time = \
        ust_get_duration(pmic_access_duration_log[PMIC_WRAPPER_WACS0_WRITE_DBG][pmic_access_duration_index].start_time, pmic_access_duration_log[PMIC_WRAPPER_WACS0_WRITE_DBG][pmic_access_duration_index].end_time);            
#endif
...
#if defined(DCL_PMIC_ACCESS_TIME_LOG)
    pmic_access_duration_log[PMIC_WRAPPER_WACS1_WRITE_DBG][pmic_access_duration_index].start_time = ust_get_current_time();
#endif
...
#if defined(DCL_PMIC_ACCESS_TIME_LOG)
    pmic_access_duration_log[PMIC_WRAPPER_WACS1_WRITE_DBG][pmic_access_duration_index].end_time = ust_get_current_time();
    pmic_access_duration_log[PMIC_WRAPPER_WACS1_WRITE_DBG][pmic_access_duration_index].duration_time = \
        ust_get_duration(pmic_access_duration_log[PMIC_WRAPPER_WACS1_WRITE_DBG][pmic_access_duration_index].start_time, pmic_access_duration_log[PMIC_WRAPPER_WACS1_WRITE_DBG][pmic_access_duration_index].end_time);            
#endif
