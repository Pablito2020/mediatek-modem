...
#define SAL_PROC_NAME(v1)  (unsigned char)(v1+91)
...
#define L1Audio_Msg_AFE_Switch_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x000D, (unsigned char)(v1), (unsigned char)(v2)))
...
#define L1Audio_Msg_AFE_TurnSpk_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x010D, (unsigned char)(v1), (unsigned char)(v2)))
...
#define L1Audio_Msg_AFE_TurnMIC_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x020D, (unsigned char)(v1), (unsigned char)(v2)))
...
#define L1Audio_Msg_AFE_TurnPath_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x030D, (unsigned char)(v1), (unsigned char)(v2)))
...
#define L1Audio_Msg_AFE_SpkSelect_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x040D, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)))
...
#define L1Audio_Msg_AM_Switch_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x050D, (unsigned char)(v1), (unsigned char)(v2)))
...
#define L1Audio_Msg_AM_Handover_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x060D, (char)(v1), TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_AM_2G_Resync_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x070D, (char)(v1), (char)(v2)))
...
#define L1Audio_Msg_AM_IO_Switch_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x080D, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_AM_SetSpeech_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x090D, (unsigned char)(v1), (unsigned char)(v2)))
...
#define L1Audio_Msg_Speech_State_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A0D, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_DSP_INT_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0B0D, (unsigned short)(v1)))
...
#define L1Audio_Msg_AM_DELAY_TABLE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0C0D, (short)(v1)))
...
#define L1Audio_Msg_SPEECH_FRAME_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0D0D, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_SPEECH_CODEC_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0E0D, (unsigned char)(v1), (unsigned char)(v2)))
...
#define L1Audio_Msg_VM_DEBUG_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0F0D, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))
...
#define L1Audio_Msg_TCH_NOTIFY_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x120D, (unsigned char)(v1), (unsigned char)(v2)))
...
#define L1Audio_Msg_INTERRAT_W2G_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x130D, (unsigned short)(v1)))
...
#define L1Audio_Msg_INTERRAT_G2W_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x140D, (unsigned short)(v1)))
...
#define L1Audio_Msg_SWITCH_FILT_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x150D, (short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_AFE_RegBackup_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x160D, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_AM_SRC1_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x170D, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))
...
#define L1Audio_Msg_AM_SRC2_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x180D, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))
...
#define L1Audio_Msg_DSP_D2C_SPEECH_INT_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x190D, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_DSP_D2C_SPEECH_INT_SKIP_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1A0D, (unsigned short)(v1)))
...
#define L1Audio_Msg_DSP_D2C_SPEECH_WARNING_INT_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1B0D, (short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))
...
#define L1Audio_Msg_3G_INTRARAT_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1C0D, (unsigned short)(v1)))
...
#define L1Audio_Msg_SP3G_FORCE_RESYNC_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1D0D, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_SP3G_SEND_RESYNC_INFO_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1E0D, (short)(v1)), TRC_MERGE_2S((short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)))
...
#define L1Audio_Msg_SP3G_REYSNC_DELAY_OVERFLOW_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1F0D, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_AM_DEBUG_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x200D, (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_4C((char)(v1), (char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_AM_DSP_GAIN_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x210D, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_SAL_SET_VALUE_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x220D, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1Audio_Msg_SAL_SET_VALUE_MULTI(v1, v2, v3, v4, v5) do {\
		if(L1Audio_Trace_Filter[0]==1 && (L1Audio_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x230D, (unsigned short)(v2)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1Audio_Msg_SAL_SET_VALUE_MULTI(v1, v2, v3, v4, v5)
#endif

#define L1Audio_Msg_SAL_SET_VALUE_MULTI_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x230D, (unsigned short)(v2)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_SAL_PROC_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x240D, (unsigned short)(v2)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_SP_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x250D, (short)(v1)))
...
#define L1Audio_Msg_AM_AudioManager_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x260D, (short)(v1)))
...
#define L1Audio_Msg_AM_Resync_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x270D, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1Audio_Msg_AM_Update_Time_Drift_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x290D, (short)(v1)))
...
#define L1Audio_Msg_AM_3G_Reset_Debug_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2B0D, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1Audio_Msg_AM_Speech(v1) do {\
		if(L1Audio_Trace_Filter[0]==1 && (L1Audio_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x2C0D, (short)(v1)));\
} while(0)
#else
	#define L1Audio_Msg_AM_Speech(v1)
#endif

#define L1Audio_Msg_AM_Speech_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2C0D, (short)(v1)))
...
#define L1Audio_Msg_PutQ_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2D0D, (short)(v1)))
