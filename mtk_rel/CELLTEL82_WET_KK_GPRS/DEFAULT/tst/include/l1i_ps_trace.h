...
#include "L1Trc.h"
	...
	#define L1I_Trace_PowerControlSetC(v1, v2) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0003, (unsigned char)(v1), (char)(v2)));\
} while(0)
#else
	#define L1I_Trace_PowerControlSetC(v1, v2)
#endif

#define L1I_Trace_PowerControlSetC_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0003, (unsigned char)(v1), (char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1I_Trace_ReportTBFStarted(v1, v2, v3, v4, v5) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0103, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_ReportTBFStarted(v1, v2, v3, v4, v5)
#endif

#define L1I_Trace_ReportTBFStarted_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0103, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1I_Trace_TBF_Transition(v1, v2, v3, v4, v5) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0203, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_TBF_Transition(v1, v2, v3, v4, v5)
#endif

#define L1I_Trace_TBF_Transition_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0203, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1I_Trace_ReportTBFStopped(v1, v2) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0303, (unsigned char)(v1), TRC_BOXSTER_PAD), (long)(v2));\
} while(0)
#else
	#define L1I_Trace_ReportTBFStopped(v1, v2)
#endif

#define L1I_Trace_ReportTBFStopped_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0303, (unsigned char)(v1), TRC_BOXSTER_PAD), (long)(v2))

#if defined(L1_CATCHER)
	#define L1I_Trace_ReportPDTChConflict(v1, v2) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0403, (unsigned char)(v1), TRC_BOXSTER_PAD), (long)(v2));\
} while(0)
#else
	#define L1I_Trace_ReportPDTChConflict(v1, v2)
#endif

#define L1I_Trace_ReportPDTChConflict_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0403, (unsigned char)(v1), TRC_BOXSTER_PAD), (long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1I_Trace_ReportPRACh(v1, v2, v3, v4) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x20)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0503, (short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3));\
} while(0)
#else
	#define L1I_Trace_ReportPRACh(v1, v2, v3, v4)
#endif

#define L1I_Trace_ReportPRACh_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0503, (short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3))

#if defined(L1_CATCHER)
	#define L1I_Trace_ReportPollResp(v1, v2, v3, v4, v5, v6) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0603, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), (char)(v6)));\
} while(0)
#else
	#define L1I_Trace_ReportPollResp(v1, v2, v3, v4, v5, v6)
#endif

#define L1I_Trace_ReportPollResp_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0603, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), (char)(v6)))

#if defined(L1_CATCHER)
	#define L1I_Trace_ReportSingleDL(v1, v2) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x80)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0703, (unsigned char)(v1), (unsigned char)(v2)));\
} while(0)
#else
	#define L1I_Trace_ReportSingleDL(v1, v2)
#endif

#define L1I_Trace_ReportSingleDL_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0703, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER)
	#define L1I_Trace_ReportULTwoPhase(v1, v2, v3, v4, v5, v6) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[2]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0803, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (char)(v4), (char)(v5), (char)(v6)));\
} while(0)
#else
	#define L1I_Trace_ReportULTwoPhase(v1, v2, v3, v4, v5, v6)
#endif

#define L1I_Trace_ReportULTwoPhase_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0803, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (char)(v4), (char)(v5), (char)(v6)))

#if defined(L1_CATCHER)
	#define L1I_Trace_ReportULWithoutTBF(v1, v2, v3, v4, v5) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0903, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_ReportULWithoutTBF(v1, v2, v3, v4, v5)
#endif

#define L1I_Trace_ReportULWithoutTBF_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0903, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_MACAssigned(v1, v2, v3, v4) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[2]&0x80)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0A03, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_MACAssigned(v1, v2, v3, v4)
#endif

#define L1I_Trace_MACAssigned_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0A03, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_MACOurUSFMask(v1, v2) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0B03, (unsigned char)(v1), (unsigned char)(v2)));\
} while(0)
#else
	#define L1I_Trace_MACOurUSFMask(v1, v2)
#endif

#define L1I_Trace_MACOurUSFMask_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0B03, (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER)
	#define L1I_Trace_MACTxSpec(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[2]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0C03, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_MACTxSpec(v1, v2, v3)
#endif

#define L1I_Trace_MACTxSpec_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0C03, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_MACSetReceivedUSF(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0D03, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_MACSetReceivedUSF(v1, v2, v3)
#endif

#define L1I_Trace_MACSetReceivedUSF_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0D03, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1I_Trace_MACPreGetUplinkPDTCh(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[2]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0E03, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_MACPreGetUplinkPDTCh(v1, v2, v3)
#endif

#define L1I_Trace_MACPreGetUplinkPDTCh_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0E03, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1I_Trace_MACULStatusReport(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[2]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0F03, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_MACULStatusReport(v1, v2, v3)
#endif

#define L1I_Trace_MACULStatusReport_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0F03, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_ExtractPR1() do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1003, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_ExtractPR1()
#endif

#define L1I_Trace_ExtractPR1_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1003, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_ExtractPR2() do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1103, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_ExtractPR2()
#endif

#define L1I_Trace_ExtractPR2_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1103, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_ExtractPR3(v1, v2, v3, v4) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1203, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_ExtractPR3(v1, v2, v3, v4)
#endif

#define L1I_Trace_ExtractPR3_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1203, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_GPRS_AGC0(v1) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1303, (char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_GPRS_AGC0(v1)
#endif

#define L1I_Trace_GPRS_AGC0_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1303, (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_GPRS_AGC1(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1403, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_GPRS_AGC1(v1, v2, v3)
#endif

#define L1I_Trace_GPRS_AGC1_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1403, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_GPRS_AGC2(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1503, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_GPRS_AGC2(v1, v2, v3)
#endif

#define L1I_Trace_GPRS_AGC2_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1503, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_GPRS_AGC3(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1603, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_GPRS_AGC3(v1, v2, v3)
#endif

#define L1I_Trace_GPRS_AGC3_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1603, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_GPRS_AGC4(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1703, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_GPRS_AGC4(v1, v2, v3)
#endif

#define L1I_Trace_GPRS_AGC4_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1703, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_Trace_GPRS_AGC5(v1, v2) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1803, (char)(v1), (char)(v2)));\
} while(0)
#else
	#define L1I_Trace_GPRS_AGC5(v1, v2)
#endif

#define L1I_Trace_GPRS_AGC5_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1803, (char)(v1), (char)(v2)))

#if defined(L1_CATCHER)
	#define L1I_Trace_UL_DATA(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1903, (char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_UL_DATA(v1, v2, v3)
#endif

#define L1I_Trace_UL_DATA_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1903, (char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1I_Trace_UL_Ctrl(v1, v2) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1A03, (unsigned char)(v1), (char)(v2)));\
} while(0)
#else
	#define L1I_Trace_UL_Ctrl(v1, v2)
#endif

#define L1I_Trace_UL_Ctrl_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1A03, (unsigned char)(v1), (char)(v2)))
	...
	#define L1I_Trace_PDAN(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[3]&0x20)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x1B03, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), (unsigned char)(v9), (unsigned char)(v10)), TRC_MERGE_4C((unsigned char)(v11), (char)(v12), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_PDAN(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11, v12)
#endif

#define L1I_Trace_PDAN_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x1B03, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), (unsigned char)(v9), (unsigned char)(v10)), TRC_MERGE_4C((unsigned char)(v11), (char)(v12), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1I_Trace_PCA_AB(v1) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1C03, (char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_PCA_AB(v1)
#endif

#define L1I_Trace_PCA_AB_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1C03, (char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1I_Trace_PDTChCheckNoRRBP(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[2]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1D03, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_PDTChCheckNoRRBP(v1, v2, v3)
#endif

#define L1I_Trace_PDTChCheckNoRRBP_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1D03, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1I_Trace_UpdateTimingAdvance(v1, v2, v3) do {\
		if(L1I_GPRS_Trace_Filter[0]==1 && (L1I_GPRS_Trace_Filter[2]&0x40)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1E03, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Trace_UpdateTimingAdvance(v1, v2, v3)
#endif

#define L1I_Trace_UpdateTimingAdvance_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1E03, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
