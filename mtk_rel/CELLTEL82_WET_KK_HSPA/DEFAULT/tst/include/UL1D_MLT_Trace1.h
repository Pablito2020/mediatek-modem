...
#include "L1Trc.h"
	...
	#define UL1D_TRC_MLT_ON_OFF(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x000E, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1D_TRC_MLT_ON_OFF(v1, v2)
#endif

#define UL1D_TRC_MLT_ON_OFF_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x000E, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_MLT_FILTER_SETTING(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x010E, (unsigned short)(v1)));\
} while(0)
#else
	#define UL1D_TRC_MLT_FILTER_SETTING(v1)
#endif

#define UL1D_TRC_MLT_FILTER_SETTING_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x010E, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_MLT_TXCRP_DEFAULT(v1, v2, v3, v4, v5) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x020E, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_DEFAULT(v1, v2, v3, v4, v5)
#endif

#define UL1D_TRC_MLT_TXCRP_DEFAULT_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x020E, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_MLT_ULPC_RPP_ITP(v1, v2) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x030E, (unsigned char)(v1), (unsigned char)(v2)));\
} while(0)
#else
	#define UL1D_TRC_MLT_ULPC_RPP_ITP(v1, v2)
#endif

#define UL1D_TRC_MLT_ULPC_RPP_ITP_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x030E, (unsigned char)(v1), (unsigned char)(v2)))
	...
	#define UL1D_TRC_MLT_TXBRP_RECONFIG_FLAG() do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x040E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1D_TRC_MLT_TXBRP_RECONFIG_FLAG()
#endif

#define UL1D_TRC_MLT_TXBRP_RECONFIG_FLAG_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x040E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXBRP_MAX_TTI(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x050E, (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1D_TRC_MLT_TXBRP_MAX_TTI(v1)
#endif

#define UL1D_TRC_MLT_TXBRP_MAX_TTI_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x050E, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_TG_METHOD(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x060E, (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_TG_METHOD(v1)
#endif

#define UL1D_TRC_MLT_TXCRP_TG_METHOD_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x060E, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_CFN(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x070E, (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_CFN(v1)
#endif

#define UL1D_TRC_MLT_TXCRP_CFN_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x070E, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_MSG_STSP(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x080E, (unsigned short)(v1)));\
} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_MSG_STSP(v1)
#endif

#define UL1D_TRC_MLT_TXCRP_MSG_STSP_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x080E, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_PRE_STSP(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x090E, (unsigned short)(v1)));\
} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_PRE_STSP(v1)
#endif

#define UL1D_TRC_MLT_TXCRP_PRE_STSP_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x090E, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_MSGD_SFCC(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0A0E, (unsigned short)(v1)));\
} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_MSGD_SFCC(v1)
#endif

#define UL1D_TRC_MLT_TXCRP_MSGD_SFCC_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0A0E, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_MSGC_SFCC(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0B0E, (unsigned short)(v1)));\
} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_MSGC_SFCC(v1)
#endif

#define UL1D_TRC_MLT_TXCRP_MSGC_SFCC_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0B0E, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_TXCRP_PRE_SFCC(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0C0E, (unsigned short)(v1)));\
} while(0)
#else
	#define UL1D_TRC_MLT_TXCRP_PRE_SFCC(v1)
#endif

#define UL1D_TRC_MLT_TXCRP_PRE_SFCC_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0C0E, (unsigned short)(v1)))

#if defined(L1_CATCHER)
	#define UL1D_TRC_MLT_TM_ST_STROBE(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0D0E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
} while(0)
#else
	#define UL1D_TRC_MLT_TM_ST_STROBE(v1)
#endif

#define UL1D_TRC_MLT_TM_ST_STROBE_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0D0E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER)
	#define UL1D_TRC_MLT_TM_CS4_STROBE(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0E0E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
} while(0)
#else
	#define UL1D_TRC_MLT_TM_CS4_STROBE(v1)
#endif

#define UL1D_TRC_MLT_TM_CS4_STROBE_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0E0E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_MLT_TM_DD_STROBE(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0F0E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1));\
} while(0)
#else
	#define UL1D_TRC_MLT_TM_DD_STROBE(v1)
#endif

#define UL1D_TRC_MLT_TM_DD_STROBE_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0F0E, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_MLT_CS_EST_BIN(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x100E, (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1D_TRC_MLT_CS_EST_BIN(v1)
#endif

#define UL1D_TRC_MLT_CS_EST_BIN_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x100E, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RFM_S_RLID2PSC_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x110E, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_RFM_N_RLID2PSC(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x120E, (unsigned short)(v1)));\
} while(0)
#else
	#define UL1D_TRC_MLT_RFM_N_RLID2PSC(v1)
#endif

#define UL1D_TRC_MLT_RFM_N_RLID2PSC_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x120E, (unsigned short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_RFM_S_ST0_SYM_IDX(v1, v2, v3, v4, v5, v6) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x130E, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)));\
} while(0)
#else
	#define UL1D_TRC_MLT_RFM_S_ST0_SYM_IDX(v1, v2, v3, v4, v5, v6)
#endif

#define UL1D_TRC_MLT_RFM_S_ST0_SYM_IDX_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x130E, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1D_TRC_MLT_RFM_N_ST0_SYM_IDX(v1) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x140E, (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1D_TRC_MLT_RFM_N_ST0_SYM_IDX(v1)
#endif

#define UL1D_TRC_MLT_RFM_N_ST0_SYM_IDX_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x140E, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_AGPS_IMPORTAN(v1, v2, v3, v4) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x150E, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
} while(0)
#else
	#define UL1D_TRC_AGPS_IMPORTAN(v1, v2, v3, v4)
#endif

#define UL1D_TRC_AGPS_IMPORTAN_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x150E, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_AGPS_REPORT(v1, v2, v3) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x160E, (char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3));\
} while(0)
#else
	#define UL1D_TRC_AGPS_REPORT(v1, v2, v3)
#endif

#define UL1D_TRC_AGPS_REPORT_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x160E, (char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1D_TRC_AGPS_FRC_PARAM(v1, v2, v3, v4) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x170E, (char)(v1), (char)(v3)), (unsigned long)(v2), (unsigned long)(v4));\
} while(0)
#else
	#define UL1D_TRC_AGPS_FRC_PARAM(v1, v2, v3, v4)
#endif

#define UL1D_TRC_AGPS_FRC_PARAM_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x170E, (char)(v1), (char)(v3)), (unsigned long)(v2), (unsigned long)(v4))

#if defined(L1_CATCHER)
	#define UL1D_TRC_DCH_ASU_CHECK(v1, v2, v3) do {\
		if(UL1D_MLT_SET1_Trace_Filter[0]==1 && (UL1D_MLT_SET1_Trace_Filter[1]&0x80)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x180E, (unsigned short)(v3)), (long)(v1), (long)(v2));\
} while(0)
#else
	#define UL1D_TRC_DCH_ASU_CHECK(v1, v2, v3)
#endif

#define UL1D_TRC_DCH_ASU_CHECK_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x180E, (unsigned short)(v3)), (long)(v1), (long)(v2))
