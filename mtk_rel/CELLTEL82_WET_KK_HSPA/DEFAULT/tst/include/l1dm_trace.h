...
#define L1DM_MSG_SB_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x000D, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1DM_MSG_FB_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x010D, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1DM_MSG_IRATSYNC_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x020D, (short)(v2)), (long)(v1))
...
#define L1DM_MSG_PMCell_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x030D, (short)(v1)))
...
#define L1DM_MSG_3GGap_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x040D, (short)(v2)), TRC_MERGE_1S2C((short)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD), (long)(v1), (long)(v3))
...
#define L1DM_MSG_DRXTick_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x060D, (short)(v1)))
...
#define L1DM_MSG_2GGap_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x070D, (short)(v2)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v3))
...
#define L1DM_MSG_2GGapStop_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x080D, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1DM_MSG_3GGapPriority_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0A0D, (short)(v1)))
...
#define L1DM_MSG_3GGapServiceType_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B0D, (short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1DM_MSG_3GGapServiceUpdate_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0C0D, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1DM_MSG_StopGapSchedule_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0D0D, (short)(v1)))
...
#define L1DM_MSG_GapScheduleDone_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0E0D, (short)(v1)), TRC_MERGE_1S2C((short)(v2), (unsigned char)(v3), (unsigned char)(v4)))
...
#define L1DM_MSG_FMOLock_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0F0D, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define L1DM_MSG_Lock2G_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x110D, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define L1DM_MSG_DMState_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x120D, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define L1DM_MSG_PMTick_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x130D, (short)(v1)))
...
#define L1DM_MSG_PMTick_HPSearch_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x140D, (short)(v1)))
...
#define L1DM_MSG_PMDone_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x150D, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#define L1DM_MSG_GapSession_TD_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) TRC_SEND_9_DATA(TRC_MERGE_2S(0x170D, (short)(v1)), TRC_MERGE_2S((short)(v4), (short)(v7)), TRC_MERGE_1S2C((short)(v10), (unsigned char)(v2), TRC_BOXSTER_PAD), (long)(v3), (long)(v5), (long)(v6), (long)(v8), (long)(v9), (long)(v11))
...
#define L1DM_MSG_GapType_TD_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x180D, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_4C((unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1DM_MSG_SetGap_TD_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_6_DATA(TRC_MERGE_2S(0x190D, (short)(v1)), TRC_MERGE_2S((short)(v4), (short)(v7)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v6), (unsigned char)(v9), TRC_BOXSTER_PAD), (long)(v2), (long)(v5), (long)(v8))
...
#define L1DM_MSG_BSICSchedule_TD_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1A0D, (short)(v1)), TRC_MERGE_1S2C((short)(v4), (unsigned char)(v2), (unsigned char)(v3)), (long)(v5))
...
#define L1DM_MSG_PMLock_TD_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1B0D, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define L1DM_MSG_PMPeriod_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1C0D, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define L1DM_MSG_ReselMode_Standby_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1D0D, (unsigned char)(v1), (unsigned char)(v2)))
