...
#define UL1D_TRC_MLT_PREPROCESSOR_DEFAULT_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x000F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_CLTD_DEFAULT_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x010F, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v3), (unsigned char)(v2), TRC_BOXSTER_PAD), (unsigned long)(v4))
...
#define UL1D_TRC_MLT_SIREST_DEFAULT_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x020F, (unsigned short)(v1)))
...
#define UL1D_TRC_MLT_DPC_DEFAULT_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x030F, (char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_TPC_CMB_DEFAULT_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x040F, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v2), TRC_BOXSTER_PAD), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_TRC_MLT_AICH_DEFAULT_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x050F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_MLT_PICH_DEFAULT_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x060F, (unsigned short)(v1)))
...
#define UL1D_TRC_MLT_RXBRP_DEFAULT_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x070F, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_PICH_POWER_OFFSET_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x080F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_DQE_TPC_SIR_LTA_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x090F, (short)(v1)))
...
#define UL1D_TRC_MLT_DQE_LNK_EST_IND_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0A0F, (char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_DQE_SYNC_STATUS_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0B0F, (char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_DPC_TARGET_SIR_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7) TRC_SEND_9_DATA(TRC_MERGE_1S2C(0x0C0F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2), (long)(v3), (long)(v4), (long)(v5), (long)(v6), (long)(v7), (long)(v8))
...
#define UL1D_TRC_MLT_DPC_TARGET_SIR_2_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7) TRC_SEND_9_DATA(TRC_MERGE_1S2C(0x0D0F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2), (long)(v3), (long)(v4), (long)(v5), (long)(v6), (long)(v7), (long)(v8))
...
#define UL1D_TRC_MLT_DPC_DPDCH_SIR_LTA_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0E0F, (short)(v1)))
...
#define UL1D_TRC_MLT_DPC_TARGET_BLER_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7) TRC_SEND_5_DATA(TRC_MERGE_2S(0x0F0F, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v6), (short)(v7)), TRC_MERGE_1S2C((short)(v8), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_AGC_M_N_E_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x100F, (short)(v4)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v2), (long)(v3))
...
#define UL1D_TRC_MLT_PAC_DISTANCE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x110F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_DESPRD_CFG_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x120F, (unsigned short)(v1)))
...
#define UL1D_TRC_MLT_TRK_THRESHOLD_CFG_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x130F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_MLT_SPEST_ACC_FRAME_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x140F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_SPEST_LPF1_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x150F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_MLT_SPEST_LPF2_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x160F, (unsigned short)(v1)))
...
#define UL1D_TRC_MLT_SPEST_HPF1_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x170F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_MLT_SPEST_HPF2_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x180F, (unsigned short)(v1)))
...
#define UL1D_TRC_MLT_FOE_THR1_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x190F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_MLT_FOE_THR2_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1A0F, (unsigned short)(v1)))
...
#define UL1D_TRC_MLT_FOE_CON_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1B0F, (unsigned short)(v1)))
...
#define UL1D_TRC_MLT_AFC_SWT_HYST_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1C0F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_AFC_SWT_THRE_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1D0F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_MLT_CHEST_CFG_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1E0F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_MLT_AFC_INITIAL_FREQ_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1F0F, (unsigned short)(v1)))
...
#define UL1D_TRC_MLT_SPEST_RESET_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x200F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RTR_RAKECON_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x210F, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_TM_ADV_RET_ADJUST_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x220F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_TM_PAC_EVENT_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x230F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_MLT_PAC_CON_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x240F, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_MLT_CG_RLN_PSC_SSC_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x250F, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3))
...
#define UL1D_TRC_MLT_CG_RL6_PSC_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x260F, (unsigned short)(v1)))
...
#define UL1D_TRC_MLT_RXBRP_CCN_TFCI_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x270F, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_CCN_RECFG_FLAG_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x280F, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_CCN_DATA_TFI_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x290F, (unsigned short)(v5)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4)), TRC_MERGE_4C((unsigned char)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_CCN_CFN_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2A0F, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_MLT_RXBRP_CC1_CM_TYPE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2B0F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_CC1_CM_PURPOSE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2C0F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_CC1_NFIRST_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2D0F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_CC1_NLAST_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2E0F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_CCN_U_PhCHCnt_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2F0F, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_BCH_SFN_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x300F, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3))
...
#define UL1D_TRC_MLT_RXBRP_BCH_MD_BOFF_RCRC_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x310F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_BCH_ENABLE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x320F, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_BCH_CRC_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x330F, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2))
...
#define UL1D_TRC_MLT_RXBRP_BCH_CMB_TICK_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x340F, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_MLT_RXBRP_BTFD_PASS_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x350F, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_TRCH_ID_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x360F, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)), TRC_MERGE_4C((unsigned char)(v7), (unsigned char)(v8), (unsigned char)(v9), (unsigned char)(v10)))
...
#define UL1D_TRC_MLT_RXBRP_REMOVE_CRC_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x380F, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2))
...
#define UL1D_TRC_MLT_RXBRP_FRAME_SCF_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x390F, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MLT_RXBRP_CCN_ENABLE_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3A0F, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_MLT_RXSRP_RESET_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3B0F, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
