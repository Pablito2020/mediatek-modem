...
#include "L1Trc.h"
	...
	#define L1I_Msg_AFC_Assert_Reason(v1) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x02)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0007, (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Msg_AFC_Assert_Reason(v1)
#endif

#define L1I_Msg_AFC_Assert_Reason_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0007, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1I_Msg_AFC_TQ_TIME(v1, v2) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0107, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Msg_AFC_TQ_TIME(v1, v2)
#endif

#define L1I_Msg_AFC_TQ_TIME_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0107, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1I_Msg_AFC_Assert34(v1, v2, v3) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0207, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Msg_AFC_Assert34(v1, v2, v3)
#endif

#define L1I_Msg_AFC_Assert34_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0207, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1I_Msg_AFC_Tid_MisMatch(v1, v2, v3) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0307, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_Msg_AFC_Tid_MisMatch(v1, v2, v3)
#endif

#define L1I_Msg_AFC_Tid_MisMatch_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0307, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_SB_Status_Extend(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x04)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_2S(0x0407, (short)(v2)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v7), (short)(v8)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), (char)(v6), (unsigned char)(v9)), TRC_MERGE_4C((unsigned char)(v10), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_SB_Status_Extend(v1, v2, v3, v4, v5, v6, v7, v8, v9, v10)
#endif

#define L1D_SB_Status_Extend_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9) TRC_SEND_5_DATA(TRC_MERGE_2S(0x0407, (short)(v2)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v7), (short)(v8)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), (char)(v6), (unsigned char)(v9)), TRC_MERGE_4C((unsigned char)(v10), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1D_Trc_HIGHSNR_BADBLOCK() do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0507, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_Trc_HIGHSNR_BADBLOCK()
#endif

#define L1D_Trc_HIGHSNR_BADBLOCK_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0507, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1D_SP_flag(v1) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0607, (short)(v1)));\
} while(0)
#else
	#define L1D_SP_flag(v1)
#endif

#define L1D_SP_flag_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0607, (short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1D_SP_flag_Fsig_no_data_tx(v1) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[1]&0x08)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_2S(0x0707, (short)(v1)));\
} while(0)
#else
	#define L1D_SP_flag_Fsig_no_data_tx(v1)
#endif

#define L1D_SP_flag_Fsig_no_data_tx_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0707, (short)(v1)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1I_DCM_status(v1) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[1]&0x10)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0807, (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1I_DCM_status(v1)
#endif

#define L1I_DCM_status_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0807, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_PCH_OK_AT_STATE(v1, v2) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0907, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_PCH_OK_AT_STATE(v1, v2)
#endif

#define L1D_PCH_OK_AT_STATE_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0907, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_CCCH_OK_AT_STATE(v1, v2) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0A07, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_CCCH_OK_AT_STATE(v1, v2)
#endif

#define L1D_CCCH_OK_AT_STATE_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0A07, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1D_PCH_One_Burst_Enable(v1, v2) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[1]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B07, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_PCH_One_Burst_Enable(v1, v2)
#endif

#define L1D_PCH_One_Burst_Enable_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B07, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1D_PCH_Null_Detect(v1) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[1]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C07, (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_PCH_Null_Detect(v1)
#endif

#define L1D_PCH_Null_Detect_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C07, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1D_PCH_Empty_Detect(v1) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[1]&0x20)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0D07, (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_PCH_Empty_Detect(v1)
#endif

#define L1D_PCH_Empty_Detect_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0D07, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_PCH_Pattern(v1, v2, v3, v4, v5, v6, v7, v8) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x0E07, (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_2S((unsigned short)(v6), (unsigned short)(v7)), TRC_MERGE_1S2C((unsigned short)(v8), (unsigned char)(v1), (unsigned char)(v2)));\
} while(0)
#else
	#define L1D_PCH_Pattern(v1, v2, v3, v4, v5, v6, v7, v8)
#endif

#define L1D_PCH_Pattern_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0E07, (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_2S((unsigned short)(v6), (unsigned short)(v7)), TRC_MERGE_1S2C((unsigned short)(v8), (unsigned char)(v1), (unsigned char)(v2)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define L1D_TRC_PM(v1, v2, v3, v4) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[1]&0x40)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0F07, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_TRC_PM(v1, v2, v3, v4)
#endif

#define L1D_TRC_PM_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0F07, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1D_Trc_DP6TapEQStatus(v1, v2) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[1]&0x80)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1007, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_Trc_DP6TapEQStatus(v1, v2)
#endif

#define L1D_Trc_DP6TapEQStatus_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1007, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_DSP_WATCH_DOG(v1, v2) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x08)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1107, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_DSP_WATCH_DOG(v1, v2)
#endif

#define L1D_DSP_WATCH_DOG_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1107, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_DSP_RX_FILTER(v1, v2) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x10)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1207, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_DSP_RX_FILTER(v1, v2)
#endif

#define L1D_DSP_RX_FILTER_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1207, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_CD2nd_CRC_Pass(v1, v2, v3) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x20)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1307, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_Trc_CD2nd_CRC_Pass(v1, v2, v3)
#endif

#define L1D_Trc_CD2nd_CRC_Pass_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1307, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_Tx_ARFCN_TA(v1, v2, v3) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x40)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1407, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_Trc_Tx_ARFCN_TA(v1, v2, v3)
#endif

#define L1D_Trc_Tx_ARFCN_TA_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1407, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_Timing_Check_Fail_v1(v1, v2, v3, v4) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x80)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1507, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4));\
} while(0)
#else
	#define L1D_Trc_Timing_Check_Fail_v1(v1, v2, v3, v4)
#endif

#define L1D_Trc_Timing_Check_Fail_v1_NOFLTR(v0, v1, v2, v3) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1507, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))

#if defined(L1_CATCHER)
	#define L1D_Trc_Timing_Check_Fail_v2(v1, v2, v3) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x80)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x1607, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3));\
} while(0)
#else
	#define L1D_Trc_Timing_Check_Fail_v2(v1, v2, v3)
#endif

#define L1D_Trc_Timing_Check_Fail_v2_NOFLTR(v0, v1, v2) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x1607, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER)
	#define L1D_Trc_Execute_Timing_Check(v1, v2) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x80)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1707, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_Trc_Execute_Timing_Check(v1, v2)
#endif

#define L1D_Trc_Execute_Timing_Check_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1707, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_DSP_PM_Not_Done(v1, v2, v3) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[4]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1807, (unsigned short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)));\
} while(0)
#else
	#define L1D_Trc_DSP_PM_Not_Done(v1, v2, v3)
#endif

#define L1D_Trc_DSP_PM_Not_Done_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1807, (unsigned short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1D_Trc_AFC_DAC_Data(v1, v2, v3, v4) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[2]&0x40)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1907, (short)(v2)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_Trc_AFC_DAC_Data(v1, v2, v3, v4)
#endif

#define L1D_Trc_AFC_DAC_Data_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1907, (short)(v2)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1D_Trc_MPLL_FH(v1, v2, v3, v4, v5, v6, v7, v8) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[2]&0x80)!=0 )\
			TRC_SEND_7_DATA(TRC_MERGE_2S(0x1A07, (short)(v2)), TRC_MERGE_1S2C((short)(v7), (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v8));\
} while(0)
#else
	#define L1D_Trc_MPLL_FH(v1, v2, v3, v4, v5, v6, v7, v8)
#endif

#define L1D_Trc_MPLL_FH_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7) TRC_SEND_7_DATA(TRC_MERGE_2S(0x1A07, (short)(v2)), TRC_MERGE_1S2C((short)(v7), (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6), (unsigned long)(v8))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1D_Trc_LCD_Collision(v1, v2, v3, v4, v5, v6) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[2]&0x80)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1B07, (short)(v4)), TRC_MERGE_2S((short)(v5), (short)(v6)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_Trc_LCD_Collision(v1, v2, v3, v4, v5, v6)
#endif

#define L1D_Trc_LCD_Collision_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1B07, (short)(v4)), TRC_MERGE_2S((short)(v5), (short)(v6)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1D_Trc_FCCh_Start(v1, v2, v3, v4) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[4]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1C07, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v4));\
} while(0)
#else
	#define L1D_Trc_FCCh_Start(v1, v2, v3, v4)
#endif

#define L1D_Trc_FCCh_Start_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1C07, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v4))

#if defined(L1_CATCHER)
	#define L1D_Trc_FCCh_Stop(v1, v2, v3, v4) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[4]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1D07, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), (char)(v4)));\
} while(0)
#else
	#define L1D_Trc_FCCh_Stop(v1, v2, v3, v4)
#endif

#define L1D_Trc_FCCh_Stop_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1D07, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), (char)(v4)))

#if defined(L1_CATCHER)
	#define L1D_Trc_FB_False_Alarm(v1, v2, v3, v4, v5, v6) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[4]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x1E07, (short)(v2)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), (unsigned char)(v1), (char)(v3)));\
} while(0)
#else
	#define L1D_Trc_FB_False_Alarm(v1, v2, v3, v4, v5, v6)
#endif

#define L1D_Trc_FB_False_Alarm_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1E07, (short)(v2)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), (unsigned char)(v1), (char)(v3)))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1D_Trc_TXPC(v1, v2, v3) do {\
		if(L1D_SEC_Trace_Filter[0]==1 && (L1D_SEC_Trace_Filter[3]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x1F07, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1D_Trc_TXPC(v1, v2, v3)
#endif

#define L1D_Trc_TXPC_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1F07, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))
