...
#define UL1D_TRC_RFM_ADD_RL_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0013, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))
...
#define UL1D_TRC_RFM_DELETE_RL_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0113, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))
...
#define UL1D_TRC_FINGER_INFO_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0213, (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_FINGER_INFO1_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0313, (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), (char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_FINGER_ASSIGN_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0413, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (char)(v2), (unsigned char)(v4), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MPS_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) TRC_SEND_6_DATA(TRC_MERGE_2S(0x0513, (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v6), (short)(v7)), TRC_MERGE_2S((unsigned short)(v8), (unsigned short)(v9)), TRC_MERGE_2S((unsigned short)(v10), (unsigned short)(v11)), TRC_MERGE_1S2C((unsigned short)(v12), (char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_RFM_STATE_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0613, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_RFM_THR_MODE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0713, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_REFERENCE_CELL_ID_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0813, (char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RFM_REFERENCE_PAC_ADDR_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0913, (unsigned short)(v1)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v2))
...
#define UL1D_TRC_RFM_MAX_DELAY_PATH_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0A13, (unsigned short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RFM_ACTIVE_FRAMES_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0B13, (char)(v1), (char)(v2)))
...
#define UL1D_TRC_RFM_RL_FRAMES_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C13, (char)(v1), (char)(v2)))
...
#define UL1D_TRC_RFM_ROUNDROBIN_LIST_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0D13, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), (char)(v6)), TRC_MERGE_4C((char)(v7), (char)(v8), (char)(v9), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RFM_ROUND_ROBIN_CHANGE_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0E13, (char)(v1), (char)(v2)))
...
#define UL1D_TRC_RFM_All_RL_FRAMES_NOFLTR(v0, v1, v2, v3, v4, v5, v6) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0F13, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), (char)(v6)), TRC_MERGE_4C((char)(v7), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RFM_SCHEDULE_FRAME_CNT_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1013, (char)(v1), (char)(v2)))
...
#define UL1D_TRC_RFM_START_FOR_RL_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1113, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RFM_STOP_FOR_RL_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1213, (char)(v1), (char)(v2)))
...
#define UL1D_TRC_PS_EVENT_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1313, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PS_DONE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1413, (short)(v1)))
...
#define UL1D_TRC_PS_MIX_FB_PREFER_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1513, (unsigned short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PS_SORTED_LIST_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1613, (unsigned short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PS_RSSI_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1713, (unsigned short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), (unsigned long)(v4))
...
#define UL1D_TRC_PS_TRIGGER_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1813, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))
...
#define UL1D_TRC_PS_RANGE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1913, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PS_LIST_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1A13, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PS_RSSISNIFFER_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1B13, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PS_RSSISNIFFER_REF_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1C13, (unsigned short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PS_STAGE2_START_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1D13, (unsigned short)(v1)))
...
#define UL1D_TRC_PS_ESTIMATE_FINISH_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1E13, (char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PS_ESTIMATE_START_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1F13, (short)(v1)), TRC_MERGE_1S2C((short)(v2), (char)(v3), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PS_SUSPEND_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2013, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PS_INVALID_RSSI_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2113, (short)(v1)))
...
#define UL1D_TRC_PS_FullBand_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2213, (short)(v2)), TRC_MERGE_4C((unsigned char)(v3), (char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_CS_STATE_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2313, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_ST_MASK_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2413, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_ICS_STATE_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2513, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#define UL1D_TRC_CS_START_MULTI_FREQ_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2613, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_START_FREQ_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2713, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_CS4_FREQ_OFFSET_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2813, (short)(v1)))
...
#define UL1D_TRC_CS_CELL_FOUND1_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2913, (short)(v1)), TRC_MERGE_4C((char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_CELL_FOUND2_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2A13, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3))
...
#define UL1D_TRC_CS_INTERFACE_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2B13, (short)(v2)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_1S2C((short)(v5), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_CFE_BIN_INI_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2C13, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_CFE_BIN_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2D13, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_AFC_DAC_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2E13, (short)(v1)))
...
#define UL1D_TRC_RF_RXON_NOFLTR(v0, v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x2F13, (unsigned short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((unsigned short)(v6), (unsigned short)(v7)))
...
#define UL1D_TRC_RF_RXOFF_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3013, (unsigned short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((unsigned short)(v5), (unsigned short)(v6)), TRC_MERGE_4C((char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RF_TXON_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3113, (unsigned short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (unsigned short)(v5)), TRC_MERGE_1S2C((unsigned short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RF_TXOFF_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3213, (unsigned short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (unsigned short)(v5)), TRC_MERGE_1S2C((unsigned short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RF_PROGEVENT_DONE_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3313, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RF_RX_RECONFIG_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3413, (short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_1S2C((short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RF_extend_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3513, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))
...
#define UL1D_TRC_TX_RF_POWER_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3613, (char)(v1), (char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_TX_DAC_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3713, (short)(v1)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), TRC_MERGE_4C((char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RF_DBG_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3813, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v3), (unsigned char)(v2), (unsigned char)(v5)), (unsigned long)(v4))
...
#define UL1D_TRC_RF_IMM_DBG_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3913, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3))
...
#define UL1D_TRC_RF_IMM_OFF_DELAY_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3A13, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RF_RXOFF_CANCEL_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3B13, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#define UL1D_TRC_RF_GAIN_SET_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3C13, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#define UL1D_TRC_RF_GAIN_SAVE_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3D13, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)))
...
#define UL1D_TRC_TXCRP_AWAKE_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3E13, (unsigned char)(v2), (unsigned char)(v3)), (unsigned long)(v1))
...
#define UL1D_TRC_RF_RXDCCAL_ON_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3F13, (short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_1S2C((unsigned short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
