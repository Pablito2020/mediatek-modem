...
#include "L1Trc.h"
	...
	#define L1_Trc_Multi_AFC_Update_Mode(v1, v2, v3, v4, v5) do {\
		if(L1_AFC_Trace_Filter[0]==1 && (L1_AFC_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0024, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5)));\
} while(0)
#else
	#define L1_Trc_Multi_AFC_Update_Mode(v1, v2, v3, v4, v5)
#endif

#define L1_Trc_Multi_AFC_Update_Mode_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0024, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5)))

#if defined(L1_CATCHER)
	#define L1_Trc_Multi_AFC_Current_Mode(v1, v2, v3, v4, v5, v6, v7, v8, v9) do {\
		if(L1_AFC_Trace_Filter[0]==1 && (L1_AFC_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0124, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5)), TRC_MERGE_4C((unsigned char)(v6), (unsigned char)(v7), (unsigned char)(v8), (unsigned char)(v9)));\
} while(0)
#else
	#define L1_Trc_Multi_AFC_Current_Mode(v1, v2, v3, v4, v5, v6, v7, v8, v9)
#endif

#define L1_Trc_Multi_AFC_Current_Mode_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0124, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5)), TRC_MERGE_4C((unsigned char)(v6), (unsigned char)(v7), (unsigned char)(v8), (unsigned char)(v9)))
	...
	#define L1_Trc_Multi_AFC_Query_Mode(v1, v2, v3, v4, v5, v6) do {\
		if(L1_AFC_Trace_Filter[0]==1 && (L1_AFC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0224, (short)(v1)), TRC_MERGE_1S2C((short)(v4), (unsigned char)(v2), (unsigned char)(v3)), TRC_MERGE_4C((unsigned char)(v5), (unsigned char)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1_Trc_Multi_AFC_Query_Mode(v1, v2, v3, v4, v5, v6)
#endif

#define L1_Trc_Multi_AFC_Query_Mode_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0224, (short)(v1)), TRC_MERGE_1S2C((short)(v4), (unsigned char)(v2), (unsigned char)(v3)), TRC_MERGE_4C((unsigned char)(v5), (unsigned char)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1_Trc_Multi_AFC_Query_Dac(v1, v2, v3, v4, v5, v6) do {\
		if(L1_AFC_Trace_Filter[0]==1 && (L1_AFC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0324, (short)(v1)), TRC_MERGE_2S((short)(v4), (short)(v6)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v5), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1_Trc_Multi_AFC_Query_Dac(v1, v2, v3, v4, v5, v6)
#endif

#define L1_Trc_Multi_AFC_Query_Dac_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0324, (short)(v1)), TRC_MERGE_2S((short)(v4), (short)(v6)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v5), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define L1_Trc_Multi_AFC_Query_Latest_Owner(v1, v2, v3) do {\
		if(L1_AFC_Trace_Filter[0]==1 && (L1_AFC_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0424, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1_Trc_Multi_AFC_Query_Latest_Owner(v1, v2, v3)
#endif

#define L1_Trc_Multi_AFC_Query_Latest_Owner_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0424, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1_Trc_Multi_AFC_ControlMode_Switch(v1, v2, v3) do {\
		if(L1_AFC_Trace_Filter[0]==1 && (L1_AFC_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0524, (short)(v1)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v2), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define L1_Trc_Multi_AFC_ControlMode_Switch(v1, v2, v3)
#endif

#define L1_Trc_Multi_AFC_ControlMode_Switch_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0524, (short)(v1)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v2), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define L1_Trc_Multi_AFC_Dbg_Info(v1, v2, v3, v4, v5, v6, v7, v8, v9) do {\
		if(L1_AFC_Trace_Filter[0]==1 && (L1_AFC_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_5_DATA(TRC_MERGE_2S(0x0624, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v6), (short)(v7)), TRC_MERGE_2S((short)(v8), (short)(v9)));\
} while(0)
#else
	#define L1_Trc_Multi_AFC_Dbg_Info(v1, v2, v3, v4, v5, v6, v7, v8, v9)
#endif

#define L1_Trc_Multi_AFC_Dbg_Info_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_5_DATA(TRC_MERGE_2S(0x0624, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)), TRC_MERGE_2S((short)(v6), (short)(v7)), TRC_MERGE_2S((short)(v8), (short)(v9)))
