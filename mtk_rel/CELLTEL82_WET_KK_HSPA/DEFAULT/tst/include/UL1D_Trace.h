...
#define UL1D_TRC_EVENT_SLOT_ECHIPS_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0010, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_TIME_MARGIN_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0110, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2))
...
#define UL1D_TRC_LOG3G_SCALER_START_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0210, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_LOG3G_TRIGGER_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0310, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3))
...
#define UL1D_TRC_LOG3G_UL1D_LOG_STS_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0410, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_LOG3G_USB_BUF_STS3_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x0510, (unsigned short)(v1)))
...
#define UL1D_TRC_CHECK_SLEEP_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0610, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CHECK_SLEEP2_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0710, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))
...
#define UL1D_TRC_CHECK_SLEEP3_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0810, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_WAKEUP_HISR_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0910, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MIN_TIME_MARGIN_NOFLTR(v0, v1, v2, v3) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x0A10, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_TRC_MIN_TIME_MARGIN2_NOFLTR(v0, v1) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0B10, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
...
#define UL1D_TRC_MIN_TIME_MARGIN3_NOFLTR(v0, v1, v2, v3) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x0C10, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_TRC_MIN_TIME_MARGIN4_NOFLTR(v0, v1, v2, v3) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x0D10, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_TRC_MIN_TIME_MARGIN5_NOFLTR(v0, v1, v2, v3) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x0E10, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_TRC_MIN_TIME_MARGIN6_NOFLTR(v0, v1, v2) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x0F10, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))
...
#define UL1D_TRC_MIN_TIME_DGB_NOFLTR(v0, v1, v2, v3) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1010, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_TRC_MIN_TIME_DGB1_NOFLTR(v0, v1) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1110, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
...
#define UL1D_TRC_STATE_CHANGE_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1210, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_RTR_TIME_EXTEND_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1310, (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_DUAL_RF_ERR_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x1410, (short)(v1)), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_TRC_EVENT_CH_ON_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1510, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_EVENT_CH_OFF_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1610, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_EVENT_MISC_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1710, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_TIMING_ADJ_IDLE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1810, (short)(v1)))
...
#define UL1D_TRC_TIMING_ADJ_IDLE2_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1910, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (short)(v3)))
...
#define UL1D_TRC_MISC_SIM_TYPE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1A10, (char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_PAC_EVENT_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1B10, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2))
...
#define UL1D_TRC_INVALID_TIMER_START_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x1C10, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v3), (unsigned char)(v5)), (unsigned long)(v2), (unsigned long)(v6))
...
#define UL1D_TRC_CELL_STATE_PARAM_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1D10, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v2))
...
#define UL1D_TRC_CELL_STATE_PARAM2_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1E10, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_RECOVERTIME_INFO_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1F10, (unsigned short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_FASTSLEEP_INFO_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2010, (short)(v2)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), (unsigned long)(v1))
...
#define UL1D_TRC_FDD_PHY_CAPABILITY_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2110, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_FDD_PHY_CAPABILITY2_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2210, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_FDD_PHY_CAPABILITY3_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2310, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GAP_START_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2410, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))
...
#define UL1D_TRC_TM_SYNC_TM_OFF_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_2S(0x2610, (unsigned short)(v2)), TRC_MERGE_2S((short)(v4), (short)(v6)), (long)(v1), (long)(v3), (long)(v5))
...
#define UL1D_TRC_RTR_SYNC_FRMCNT_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2710, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_DUAL_AFC_DAC_3G_TO_2G_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2810, (short)(v1)))
...
#define UL1D_TRC_DUAL_AFC_DAC_2G_TO_3G_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2910, (short)(v1)))
...
#define UL1D_TRC_DUAL_AFC_STATE_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2A10, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_DUAL_AFC_MODE_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2B10, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_DUAL_AFC_Set_SWMODE_DAC_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2C10, (short)(v1)))
...
#define UL1D_TRC_DUAL_AFC_Set_DFTC_DAC_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2D10, (short)(v1)), (long)(v2))
...
#define UL1D_TRC_DUAL_AFC_DAC_SHARING_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2E10, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_DUAL_AFC_UL1C_ASK_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2F10, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_HW_AFC_DUAL_MODE_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3010, (unsigned short)(v1)), TRC_MERGE_1S2C((short)(v3), (char)(v2), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_HW_AFC_DAC_MODE_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3110, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_META_AFC_CTRL_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3210, (unsigned short)(v2)), TRC_MERGE_1S2C((unsigned short)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))
...
#define UL1D_TRC_AFC_POWEROFF_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3310, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_HW_AFC_STA_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3410, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_HW_FOE_MNTR1_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3510, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_HW_FOE_MNTR2_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3610, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_HW_AGC_MODE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3710, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_HW_AGC_TRACKING_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3810, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_HW_RXBFE_DCO_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3910, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_HW_RXBFE_DCOH_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3A10, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_HW_RXBFE_GAIN_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3B10, (char)(v1), (char)(v2)))
...
#define UL1D_TRC_HW_RXBFE_RSSI_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3C10, (short)(v1)), TRC_MERGE_1S2C((unsigned short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))
...
#define UL1D_TRC_HW_RXBFE_AGCSET_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3D10, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v3))
...
#define UL1D_TRC_HW_RXBFE_RFSTA_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3E10, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_ERROR_MESSAGE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3F10, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define UL1D_TRC_EXIT_STEP(v1, v2) do {\
		if(UL1D_PRI_Trace_Filter[0]==1 && (UL1D_PRI_Trace_Filter[2]&0x02)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x4010, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1D_TRC_EXIT_STEP(v1, v2)
#endif

#define UL1D_TRC_EXIT_STEP_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x4010, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
void L1TRC_Send_UL1D_TRC_EXIT_STEP(short v1, short v2);
...
#define ChkL1MsgFltr_UL1D_TRC_EXIT_STEP()	ChkL1ClsFltr_UL1D_PRI_MODEM_H()
