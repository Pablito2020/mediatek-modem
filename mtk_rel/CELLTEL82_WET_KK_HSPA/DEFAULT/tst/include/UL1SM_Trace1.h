...
#include "L1Trc.h"
	...
	#define UL1SM_DBG_CALI_START() do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0020, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1SM_DBG_CALI_START()
#endif

#define UL1SM_DBG_CALI_START_NOFLTR() TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0020, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1SM_DBG_CALI_DONE(v1, v2, v3) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0120, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3));\
} while(0)
#else
	#define UL1SM_DBG_CALI_DONE(v1, v2, v3)
#endif

#define UL1SM_DBG_CALI_DONE_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0120, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1SM_DBG_LONG_CALI_DONE(v1, v2, v3) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0220, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3));\
} while(0)
#else
	#define UL1SM_DBG_LONG_CALI_DONE(v1, v2, v3)
#endif

#define UL1SM_DBG_LONG_CALI_DONE_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0220, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1SM_DBG_2G_PASS_3G(v1, v2) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0320, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2));\
} while(0)
#else
	#define UL1SM_DBG_2G_PASS_3G(v1, v2)
#endif

#define UL1SM_DBG_2G_PASS_3G_NOFLTR(v0, v1) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0320, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1SM_DBG_SW_WAKEUP(v1) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0420, (unsigned char)(v1), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1SM_DBG_SW_WAKEUP(v1)
#endif

#define UL1SM_DBG_SW_WAKEUP_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0420, (unsigned char)(v1), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1SM_DBG_CAL_SLEEP(v1, v2, v3, v4) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_4_DATA(TRC_MERGE_2S(0x0520, (unsigned short)(v3)), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v4));\
} while(0)
#else
	#define UL1SM_DBG_CAL_SLEEP(v1, v2, v3, v4)
#endif

#define UL1SM_DBG_CAL_SLEEP_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0520, (unsigned short)(v3)), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v4))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1SM_DBG_CAL_HW_SLEEP(v1, v2) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0620, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1SM_DBG_CAL_HW_SLEEP(v1, v2)
#endif

#define UL1SM_DBG_CAL_HW_SLEEP_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0620, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1SM_DBG_CHECK_SLEEP_F(v1, v2, v3, v4) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0720, (unsigned short)(v2)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v3), TRC_BOXSTER_PAD), (unsigned long)(v1));\
} while(0)
#else
	#define UL1SM_DBG_CHECK_SLEEP_F(v1, v2, v3, v4)
#endif

#define UL1SM_DBG_CHECK_SLEEP_F_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0720, (unsigned short)(v2)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v3), TRC_BOXSTER_PAD), (unsigned long)(v1))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 1) )
	#define UL1SM_DBG_CHECK_SLEEP_C(v1, v2, v3, v4, v5) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x02)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0820, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v2), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1SM_DBG_CHECK_SLEEP_C(v1, v2, v3, v4, v5)
#endif

#define UL1SM_DBG_CHECK_SLEEP_C_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0820, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v2), TRC_BOXSTER_PAD))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1SM_DBG_BEFORE_SLEEP(v1, v2, v3) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0920, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3));\
} while(0)
#else
	#define UL1SM_DBG_BEFORE_SLEEP(v1, v2, v3)
#endif

#define UL1SM_DBG_BEFORE_SLEEP_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0920, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1SM_TRC_DEBUG(v1, v2, v3) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0A20, (unsigned short)(v1)), (long)(v2), (long)(v3));\
} while(0)
#else
	#define UL1SM_TRC_DEBUG(v1, v2, v3)
#endif

#define UL1SM_TRC_DEBUG_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0A20, (unsigned short)(v1)), (long)(v2), (long)(v3))

#if defined(L1_CATCHER) && ( !defined(_L1_DISABLE_TRACE_LEVEL_) || (_L1_DISABLE_TRACE_LEVEL_ < 2) )
	#define UL1SM_TRC_DEBUG_HEX(v1, v2, v3) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x01)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0B20, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3));\
} while(0)
#else
	#define UL1SM_TRC_DEBUG_HEX(v1, v2, v3)
#endif

#define UL1SM_TRC_DEBUG_HEX_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0B20, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3))

#if defined(L1_CATCHER)
	#define UL1SM_DBG_32KLESS_WAKEUP(v1, v2) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_2_DATA(TRC_MERGE_2S(0x0C20, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1SM_DBG_32KLESS_WAKEUP(v1, v2)
#endif

#define UL1SM_DBG_32KLESS_WAKEUP_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0C20, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))

#if defined(L1_CATCHER)
	#define UL1SM_DBG_32KLESS_UPDATE_LPM(v1, v2, v3, v4, v5) do {\
		if(UL1SM_1_Trace_Filter[0]==1 && (UL1SM_1_Trace_Filter[1]&0x04)!=0 )\
			TRC_SEND_3_DATA(TRC_MERGE_2S(0x0D20, (short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD));\
} while(0)
#else
	#define UL1SM_DBG_32KLESS_UPDATE_LPM(v1, v2, v3, v4, v5)
#endif

#define UL1SM_DBG_32KLESS_UPDATE_LPM_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0D20, (short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v5), TRC_BOXSTER_PAD))
