...
#define UL1D_TRC_MEAS_SCHDL_STATE_REQ_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0012, (short)(v1)), TRC_MERGE_1S2C((unsigned short)(v3), (unsigned char)(v2), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_SCHDL_SCHEDULING_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0112, (short)(v1)), TRC_MERGE_1S2C((unsigned short)(v4), (char)(v2), (char)(v3)), TRC_MERGE_4C((char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_MPS_START_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0212, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (unsigned char)(v4), (char)(v5), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_MEAS_START_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0312, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), (char)(v4), (char)(v5), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_MEAS_CELL_INFO_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0412, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)))
...
#define UL1D_TRC_MEAS_RPT_CELL_INFO_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0512, (short)(v1)), TRC_MERGE_2S((short)(v3), (short)(v4)), (long)(v2))
...
#define UL1D_TRC_MEAS_MEAS_FINISH_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0612, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_CS3_START_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0712, (char)(v1), (char)(v2)), (long)(v3))
...
#define UL1D_TRC_MEAS_CM_AVAIL_TIME_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0812, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))
...
#define UL1D_TRC_MEAS_CAL_RSCP_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0912, (short)(v1)), TRC_MERGE_2S((short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((short)(v4), (short)(v5)))
...
#define UL1D_TRC_MEAS_REQUEST_BITS_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0A12, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_4C((unsigned char)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_CS_IRQ_INT_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B12, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v3), (unsigned char)(v2), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_MPS_CALLBACK_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0C12, (char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_RF_CONTROL_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0D12, (unsigned char)(v2), TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_MEAS_RF_CENTRAL_CONTROL_REG_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0E12, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5)), TRC_MERGE_4C((unsigned char)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_DRX_MASK_NOFLTR(v0, v1, v2) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x0F12, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))
...
#define UL1D_TRC_MEAS_SCHDL_MASK_NOFLTR(v0, v1) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1012, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
...
#define UL1D_TRC_MEAS_SET_CALLBACK_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1112, (char)(v1), (char)(v2)))
...
#define UL1D_TRC_MEAS_MEAS_TID_START_LOCATION_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1212, (char)(v1), (char)(v2)))
...
#define UL1D_TRC_MEAS_RSSI_ERROR_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1312, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CAL_AVAIL_TIME_NOFLTR(v0, v1, v2, v3, v4, v5, v6) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1412, (unsigned short)(v2)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v6)), TRC_MERGE_4C((char)(v1), (char)(v3), (char)(v5), (unsigned char)(v7)))
...
#define UL1D_TRC_MEAS_GAP_MASK_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_2S(0x1512, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v6)), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5))
...
#define UL1D_TRC_CELL_STATE_CHANGE_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1612, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_RXD_STATUS_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1712, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_RXD_DETECT_DBG_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1812, (unsigned char)(v1), TRC_BOXSTER_PAD), (long)(v2), (long)(v3), (long)(v4), (long)(v5))
...
#define UL1D_TRC_MEAS_RXD_DETECTION_CHECK_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1912, (short)(v2)), TRC_MERGE_2S((short)(v3), (unsigned short)(v4)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_RXD_DETECTION_FINAL_RESULT_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1A12, (short)(v1)), TRC_MERGE_1S2C((short)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_DD_STOP_PARAM_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1B12, (unsigned short)(v2)), (long)(v1), (unsigned long)(v3))
...
#define UL1D_TRC_DD_PARAM_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x1C12, (char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_IDLE_RFM_FRAMES_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x1D12, (short)(v1)))
...
#define UL1D_TRC_IDLE_FREE_RUN_SCHDL_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1E12, (short)(v2)), TRC_MERGE_1S2C((unsigned short)(v5), (unsigned char)(v1), (unsigned char)(v3)), TRC_MERGE_4C((char)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_IDLE_FREE_RUNNING_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1F12, (char)(v1), (char)(v2)))
...
#define UL1D_TRC_DD_RSSI_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2012, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_FA_CELL_CORRECT_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x2112, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_TRC_MS3_STATUS_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2212, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_TRC_PROHIBIT_INTER_MEAS_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x2312, (char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_START_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2412, (char)(v1), (char)(v2)))
...
#define UL1D_TRC_CS_HW_IN_USE_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x2512, (unsigned short)(v1)))
...
#define UL1D_TRC_MEAS_CHECK_CS_TIME_NOFLTR(v0, v1) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x2612, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
...
#define UL1D_TRC_MEAS_IDLE_FLAG_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2712, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_CELL_STATE_DBG1_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x2812, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_MEAS_REPORT_FROM_SIB_RFM_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2912, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_MEAS_RESULT1_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2A12, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MEAS_MEAS_RESULT2_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2B12, (short)(v2)), (long)(v1))
...
#define UL1D_TRC_MEAS_MEAS_MPS_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8, v9, v10, v11) TRC_SEND_4_DATA(TRC_MERGE_2S(0x2C12, (unsigned short)(v2)), TRC_MERGE_4C((char)(v1), (unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5)), TRC_MERGE_4C((unsigned char)(v6), (unsigned char)(v7), (unsigned char)(v8), (unsigned char)(v9)), TRC_MERGE_4C((unsigned char)(v10), (unsigned char)(v11), (unsigned char)(v12), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_TX_TIMING_OFFSET_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2D12, (short)(v2)), TRC_MERGE_4C((char)(v1), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_TIMING_TRACKING_NOFLTR(v0, v1, v2) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x2E12, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))
...
#define UL1D_TRC_DD_RSSIDBRG_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2F12, (short)(v1)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v4))
...
#define UL1D_TRC_MBD_PATH_PWR_DBG_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3012, (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_1S2C((unsigned short)(v6), (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2))
...
#define UL1D_TRC_MBD_PATH_POS_DBG_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3112, (unsigned short)(v2)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), TRC_MERGE_2S((unsigned short)(v5), (unsigned short)(v6)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_WIN_TRK_TAIL_HEAD_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3212, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_WIN_TRK_PAC_ADDR_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3312, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v4)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_WIN_TRK_ADV_RTD_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x3412, (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_UL_TFC_STATUS_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3512, (short)(v2)), (unsigned long)(v1))
...
#define UL1D_TRC_UL_TFC_BETA_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3612, (short)(v9)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v3), (unsigned char)(v4)), TRC_MERGE_4C((unsigned char)(v5), (unsigned char)(v6), (unsigned char)(v7), (unsigned char)(v8)))
...
#define UL1D_TRC_UL_TFC_FRAME_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3712, (short)(v3)), TRC_MERGE_4C((unsigned char)(v1), (unsigned char)(v2), (unsigned char)(v4), (unsigned char)(v5)))
...
#define UL1D_TRC_WGG_MEAS_EVENT_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3812, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_WGG_MEAS_RTB_REQ_STATE_NOFLTR(v0, v1) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x3912, (unsigned char)(v1), (unsigned char)(v2)))
...
#define UL1D_TRC_WGG_MEAS_GAP_END_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3A12, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))
...
#define UL1D_TRC_WGG_3G_CHANNEL_ACTIVE_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3B12, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_WGG_3G_Channel_Done_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3C12, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_SFN_CELL_INVALID_CM_DATABASE_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3D12, (short)(v1)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v2))
