...
#define UL1D_TRC_TXTD_DLDPCH_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0016, (short)(v1)), TRC_MERGE_4C((char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_STOP_TM_DBG_NOFLTR(v0, v1) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0116, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
...
#define UL1D_TRC_CS_STC_TM_DBG_NOFLTR(v0, v1) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x0216, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
...
#define UL1D_TRC_CS_ST_EN_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0316, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_DCXO_ACTION_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x0416, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_OFFSET_ADJ_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0516, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_PEAK_PWR_IFNO_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0616, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_1S2C((unsigned short)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_PEAK_POS_IFNO_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0716, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), (unsigned char)(v4), (unsigned char)(v5), (unsigned char)(v6)))
...
#define UL1D_TRC_CS_CLIPPED_BIN_ROATE_FREQ_NOFLTR(v0) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x0816, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1))
...
#define UL1D_TRC_CS3_PEAK_PWR_IFNO_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0A16, (short)(v2)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v3))
...
#define UL1D_TRC_CS12_PEAK_IFNO_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0B16, (unsigned short)(v2)), TRC_MERGE_1S2C((unsigned short)(v3), (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_CS_MBD_CS3_RESULT_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_2_DATA(TRC_MERGE_2S(0x0C16, (unsigned short)(v5)), TRC_MERGE_4C((unsigned char)(v1), (char)(v2), (char)(v3), (char)(v4)))
...
#define UL1D_TRC_MQC_RF_ACT_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x0D16, (short)(v3)), TRC_MERGE_1S2C((short)(v4), (unsigned char)(v1), (char)(v2)), TRC_MERGE_4C((char)(v5), (char)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MQC_TX_DAC_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0E16, (short)(v1)), TRC_MERGE_2S((unsigned short)(v3), (unsigned short)(v4)), TRC_MERGE_4C((char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v5))
...
#define UL1D_TRC_MQC_NEXT_ACT_NOFLTR(v0, v1, v2, v3, v4, v5, v6) TRC_SEND_4_DATA(TRC_MERGE_2S(0x0F16, (short)(v2)), TRC_MERGE_2S((unsigned short)(v4), (short)(v6)), TRC_MERGE_1S2C((short)(v7), (unsigned char)(v1), (char)(v3)), TRC_MERGE_4C((char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MQC_CURRENT_ACT_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1016, (short)(v2)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v1), (char)(v3)), TRC_MERGE_4C((char)(v5), (char)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MQC_EXE_TIME_PLUS_PD_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1116, (char)(v3), (char)(v5)), TRC_MERGE_4C((char)(v6), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (long)(v4))
...
#define UL1D_TRC_DCXO_STATUS_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7, v8) TRC_SEND_9_DATA(TRC_MERGE_2S(0x1216, (short)(v1)), TRC_MERGE_4C((unsigned char)(v9), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v2), (unsigned long)(v3), (long)(v4), (unsigned long)(v5), (long)(v6), (long)(v7), (unsigned long)(v8))
...
#define UL1D_TRC_DCXO_INI_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x1316, (unsigned char)(v1), (unsigned char)(v4)), (long)(v2), (long)(v3))
...
#define UL1D_TRC_HW_REG_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x1416, (short)(v1)), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_DFTC_PAC_PLUS_X_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x1516, (char)(v3), TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (long)(v4))
...
#define UL1D_DFTC_RX_TAG_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_4_DATA(TRC_MERGE_2S(0x1616, (unsigned short)(v4)), TRC_MERGE_4C((char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v5))
...
#define UL1D_DFTC_TX_TAG_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_6_DATA(TRC_MERGE_2S(0x1716, (short)(v4)), (long)(v1), (long)(v2), (unsigned long)(v3), (long)(v5), (long)(v6))
...
#define UL1D_DFTC_TRX_DIFF_UPDATE_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_5_DATA(TRC_MERGE_2S(0x1816, (short)(v4)), TRC_MERGE_1S2C((short)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2), (long)(v3))
...
#define UL1D_DFTC_TX_TXCRP_NOFLTR(v0, v1, v2, v3) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1916, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (long)(v3), (unsigned long)(v4))
...
#define UL1D_DFTC_RXDFE_DEBUG0_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x1A16, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6))
...
#define UL1D_DFTC_OFFLINE_PAC_SYNC_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x1B16, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (short)(v4)), (long)(v3))
...
#define UL1D_DFTC_OFFLINE_DCXOADJ_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x1C16, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)))
...
#define UL1D_DFTC_OFFLINE_X_MAPPING_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7) TRC_SEND_6_DATA(TRC_MERGE_2S(0x1D16, (short)(v1)), TRC_MERGE_2S((short)(v3), (short)(v4)), TRC_MERGE_2S((short)(v5), (short)(v6)), (unsigned long)(v2), (unsigned long)(v7), (unsigned long)(v8))
...
#define UL1D_DFTC_ADV_RET_NOFLTR(v0, v1, v2, v3) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x1E16, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_DFTC_ADV_RET_EVENT_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x1F16, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_DFTC_WIN_TRK_PAC_ADDR_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2016, (unsigned short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v4)), TRC_MERGE_1S2C((unsigned short)(v5), (char)(v3), TRC_BOXSTER_PAD))
...
#define UL1D_DFTC_WIN_TRK_EVENT_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2116, (short)(v1)), TRC_MERGE_2S((unsigned short)(v2), (unsigned short)(v3)), TRC_MERGE_4C((char)(v4), (char)(v5), (char)(v6), TRC_BOXSTER_PAD))
...
#define UL1D_DFTC_TX_OFFSET1_NOFLTR(v0, v1, v2, v3, v4, v5, v6) TRC_SEND_6_DATA(TRC_MERGE_1S2C(0x2216, (char)(v5), (unsigned char)(v6)), (long)(v1), (long)(v2), (long)(v3), (unsigned long)(v4), (long)(v7))
...
#define UL1D_DFTC_TX_OFFSET2_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x2316, (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2), (long)(v3), (long)(v4))
...
#define UL1D_DFTC_TX_OFFSET3_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_6_DATA(TRC_MERGE_1S2C(0x2416, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (unsigned long)(v2), (long)(v3), (long)(v4), (long)(v5))
...
#define UL1D_DFTC_TX_OFFSET4_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x2516, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2), (long)(v3), (long)(v4), (long)(v5), (unsigned long)(v6))
...
#define UL1D_DFTC_TX_OFFSET5_NOFLTR(v0, v1, v2, v3) TRC_SEND_5_DATA(TRC_MERGE_1S2C(0x2616, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2), (long)(v3), (long)(v4))
...
#define UL1D_DFTC_TX_OFFSET6_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x2716, (short)(v1)), (long)(v2), (long)(v3), (long)(v4))
...
#define UL1D_DFTC_RXRTR_NOFLTR(v0, v1, v2, v3, v4, v5, v6) TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x2816, (char)(v7), TRC_BOXSTER_PAD), (long)(v1), (unsigned long)(v2), (long)(v3), (unsigned long)(v4), (long)(v5), (unsigned long)(v6))
...
#define UL1D_DFTC_TX_MNTR_NOFLTR(v0, v1) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x2916, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (long)(v2))
...
#define UL1D_DFTC_DEBUG_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_5_DATA(TRC_MERGE_2S(0x2A16, (short)(v1)), (long)(v2), (long)(v3), (unsigned long)(v4), (unsigned long)(v5))
...
#define UL1D_DFTC_SET_INIT_ON_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2B16, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)), TRC_MERGE_1S2C((short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_DFTC_INIT_SETTING_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2C16, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#define UL1D_DFTC_CELL_TM_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2D16, (short)(v2)), TRC_MERGE_1S2C((short)(v3), (char)(v1), TRC_BOXSTER_PAD), (long)(v4))
...
#define UL1D_DFTC_MS3_PEAK_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x2E16, (short)(v1)), TRC_MERGE_1S2C((short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_DFTC_DD_START_TIME_NOFLTR(v0, v1, v2) TRC_SEND_3_DATA(TRC_MERGE_2S(0x2F16, (unsigned short)(v3)), TRC_MERGE_4C((unsigned char)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1))
...
#define UL1D_DFTC_DD_PROCESS_TIME_NOFLTR(v0, v1, v2, v3) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3016, (unsigned short)(v2)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v1), (char)(v3)))
...
#define UL1D_DFTC_CSIRQ_TIME_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3116, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v3), TRC_BOXSTER_PAD), (unsigned long)(v2))
...
#define UL1D_DFTC_MS3_CONB_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x3216, (unsigned char)(v1), (char)(v3)), TRC_MERGE_4C((char)(v4), (char)(v5), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v2))
...
#define UL1D_DFTC_MS3_STATUS_NOFLTR(v0, v1, v2, v3) TRC_SEND_3_DATA(TRC_MERGE_2S(0x3416, (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), (unsigned char)(v1), TRC_BOXSTER_PAD), (unsigned long)(v2))
...
#define UL1D_DFTC_MS3_CON0_NOFLTR(v0, v1, v2) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x3516, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))
...
#define UL1D_DFTC_MS3_CON1_NOFLTR(v0, v1, v2) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x3616, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))
...
#define UL1D_DFTC_MS3_CON2_NOFLTR(v0, v1, v2) TRC_SEND_4_DATA(TRC_MERGE_1S2C(0x3716, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))
...
#define UL1D_DFTC_MS3_DBG_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3816, (unsigned short)(v1)), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4))
...
#define UL1D_DFTC_DD_STATUS_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3916, (unsigned short)(v4)), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3))
...
#define UL1D_DFTC_STC_STATUS_NOFLTR(v0, v1, v2, v3) TRC_SEND_4_DATA(TRC_MERGE_2S(0x3A16, (unsigned short)(v3)), TRC_MERGE_1S2C((unsigned short)(v4), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
...
#define UL1D_DFTC_STC_SW_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x3B16, (unsigned short)(v1)))
...
#define UL1D_TRC_STA_DET_MAIN_PATH_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3C16, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#define UL1D_TRC_STA_DET_SUB_PATH_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3D16, (short)(v1)), TRC_MERGE_2S((short)(v2), (short)(v3)))
...
#define UL1D_TRC_STA_DET_CHECK_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x3E16, (short)(v1)))
...
#define UL1D_TRC_GEMI2_SUSPEND_BIT_MASK_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x3F16, (unsigned short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_SIM2_PREEMPT_COUNT_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x4016, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_RX_SUSPEND_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x4116, (short)(v1)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_TX_SUSPEND_NOFLTR(v0, v1, v2, v3, v4) TRC_SEND_3_DATA(TRC_MERGE_2S(0x4216, (short)(v1)), TRC_MERGE_2S((unsigned short)(v4), (unsigned short)(v5)), TRC_MERGE_4C((unsigned char)(v2), (unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_HSDSCH_GAP_BITMAP_NOFLTR(v0, v1) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4316, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
...
#define UL1D_TRC_GEMI2_USIM_RX_BYPASS_CHECK_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x4416, (short)(v2)), TRC_MERGE_4C((unsigned char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_USIM_HSRX_FORCE_GAP_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4516, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_USIM_HSTX_HAQ_FORCE_GAP_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4616, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_USIM_HSTX_CQI_FORCE_GAP_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4716, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_RACH_GAP_BITMAP_NOFLTR(v0, v1, v2) TRC_SEND_2_DATA(TRC_MERGE_1S2C(0x4816, (unsigned char)(v1), (unsigned char)(v2)), TRC_MERGE_4C((unsigned char)(v3), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_CPC_ULDPCCH_FDPCH_INFO_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x4916, (unsigned short)(v1)), TRC_MERGE_1S2C((unsigned short)(v2), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_EFACH_DELAY_RECEIVE_CNT_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_2S(0x4A16, (short)(v1)))
...
#define UL1D_TRC_GEMI2_STS_HSDSCH_RESET_NOFLTR(v0) TRC_SEND_1_DATA(TRC_MERGE_1S2C(0x4B16, (unsigned char)(v1), TRC_BOXSTER_PAD))
...
#define UL1D_TRC_GEMI2_STS_HSDSCH_NUMBER_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7) TRC_SEND_8_DATA(TRC_MERGE_1S2C(0x4C16, (unsigned char)(v1), TRC_BOXSTER_PAD), (long)(v2), (long)(v3), (long)(v4), (long)(v5), (long)(v6), (long)(v7), (long)(v8))
...
#define UL1D_TRC_GEMI2_STS_EDCH_NUMBER_NOFLTR(v0, v1, v2, v3, v4, v5, v6, v7) TRC_SEND_9_DATA(TRC_MERGE_1S2C(0x4E16, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (long)(v1), (long)(v2), (long)(v3), (long)(v4), (long)(v5), (long)(v6), (long)(v7), (long)(v8))
...
#define UL1D_TRC_MTCMOS_STATUS_NOFLTR(v0, v1) TRC_SEND_3_DATA(TRC_MERGE_1S2C(0x4F16, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2))
...
#define UL1D_TRC_MTCMOS_EVENT_NOFLTR(v0, v1) TRC_SEND_2_DATA(TRC_MERGE_2S(0x5016, (short)(v2)), TRC_MERGE_4C((char)(v1), TRC_BOXSTER_PAD, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD))
...
#define UL1D_TRC_MTCMOS_DBG_NOFLTR(v0, v1, v2, v3, v4, v5) TRC_SEND_7_DATA(TRC_MERGE_1S2C(0x5116, TRC_BOXSTER_PAD, TRC_BOXSTER_PAD), (unsigned long)(v1), (unsigned long)(v2), (unsigned long)(v3), (unsigned long)(v4), (unsigned long)(v5), (unsigned long)(v6))
