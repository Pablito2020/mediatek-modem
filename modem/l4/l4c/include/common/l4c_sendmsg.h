...
#define NBR_IPC_MSG(msg_id) \
    (IPC_MSG_ID_MMI_NBR_BEGIN + msg_id - MSG_ID_L4C_NBR_CELL_INFO_REG_REQ)

extern void l4c_send_ilm_ipc(kal_uint32 dest, msg_type msg_name, void *param_ptr);

#if defined(__AGPS_CONTROL_PLANE__)
extern void l4c_ss_mtlr_begin_res_lrsp_ipc(kal_bool result, kal_uint8 ss_id);
extern void l4c_ss_aerq_begin_res_lrsp_ipc(kal_bool result, kal_uint8 ss_id);
extern void l4c_ss_aerp_begin_lrsp_ipc(kal_bool result, kal_uint16 cause, kal_uint8 ss_id);
extern void l4c_ss_aerp_end_lrsp_ipc(kal_bool result);
extern void l4c_ss_aecl_begin_res_lrsp_ipc(kal_bool result, kal_uint8 ss_id);
extern void l4c_ss_molr_begin_lrsp_ipc(kal_bool result, 
                                       kal_uint16 cause, 
                                       L4C_SS_LCS_MOLRRes *molr_res, 
                                       kal_uint8 ss_id);
extern void l4c_ss_molr_end_lrsp_ipc(kal_bool result);
extern void l4c_ss_mtlr_begin_lind_ipc(L4C_SS_LocationNotificationArg *notification, kal_uint8 ss_id);
extern void l4c_ss_aerq_begin_lind_ipc(L4C_SS_LCS_AreaEventRequestArg *aerq, kal_uint8 ss_id);
extern void l4c_ss_aecl_begin_lind_ipc(L4C_SS_LCS_AreaEventCancellationArg *aecl, kal_uint8 ss_id);
extern void l4c_agps_reset_positioning_lind_ipc(void);
extern void l4c_agps_cp_start_lind_ipc(void);
extern void l4c_agps_cp_end_lind_ipc(void);
#ifdef __UAGPS_CP_SUPPORT__
extern void l4c_agps_new_key_needed_lind_ipc(void);
