...
extern kal_bool l4c_nw_get_band_req(kal_uint8 src_id, kal_uint8 *gsm_band, kal_uint8 *umts_fdd_band, kal_uint8 *supported_gsm_band, kal_uint8 *supported_umts_fdd_band);
