...
{
   int            arfcn;
#if IS_EPSK_TX_SUPPORT || IS_RF_MT6162 || IS_RF_MT6163 || IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166 || IS_RF_MT6165
   ...
   #elif IS_RF_MT6256RF || IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166 || IS_RF_MT6165
      #if IS_EPSK_TX_SUPPORT
   unsigned short tx_gain_setting[TXPC_SLOT_MAX];
      #endif
   #endif
...
#if IS_RF_MT6256RF || IS_RF_MT6251RF || IS_RF_MT6255RF || IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166 || IS_RF_MT6165
...
#if IS_RF_MT6163 || IS_RF_MT6280RF || IS_RF_MT6167 || IS_RF_MT6166 || IS_RF_MT6165
