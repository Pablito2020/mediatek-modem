...
ifdef GPS_SUPPORT
  ifeq ($(strip $(GPS_SUPPORT)),SMART_PHONE_MODEM)
    COMP_TRACE_DEFS_MODEM += middleware/gps/inc/gps_trc.h
...
NEED_ADD_PMIC_COMPILE_LIST = MT6223PMU MT6238PMU MT6235PMU MT6236PMU MT6573PMU MT6575PMU MT6577PMU MT6305 MT6318 MT6326 MT6253PMU MT6253ELPMU MT6252PMU MT6326_CCCI MT6251PMU MT6276PMU MT6256PMU MT6921PMU MT6329 MT6255PMU MT6922PMU MT6250PMU MT6327 MT6320 MT6323
...
ifeq ($(strip $(USB_SUPPORT)),TRUE)
  USB_SUPPORT_PLATFORM = MT6280 MT6575 MT6577 MT6589 MT6571 MT6572 MT6582 MT6592 MT6571
...
ifdef EDGE_SUPPORT
  ifeq ($(strip $(EDGE_SUPPORT)),TRUE)
    EDGE_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589 MT6571 MT6572 MT6582 MT6592
    ...
    L1_EPSK_TX_SUPPORT_RF_MODULE = MT6140D_RF AD6546_RF SKY74137_RF SKY74045_RF MT6256RF_RF MT6162_RF MT6163_2G_RF MT6168_2G_RF MT6280RF_2G_RF MT6167_2G_RF MT6166_2G_RF MT6165_2G_RF
...
ifdef USB_HS_SUPPORT
  ifeq ($(strip $(USB_HS_SUPPORT)),TRUE)
     ifneq ($(strip $(USB_SUPPORT)),TRUE)
       ...
       USB_HS_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589 MT6571 MT6572 MT6582 MT6592 MT6571
...
ifeq ($(strip $(AMRWB_LINK_SUPPORT)),TRUE)
  AMRWB_LINK_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589 MT6571 MT6572 MT6582 MT6592
...
CENTRALIZED_SLEEP_MANAGER_PLATFORM = MT6575 MT6280 MT6577 MT6589 MT6571 MT6572 MT6582 MT6571 MT6592
...
MULTI_LNA_MODE_CALIBRATION_SUPPORT_PLATFORM = MT6575 MT6280 MT6577 MT6589 MT6582 MT6592 MT6571
...
CR4_PLATFORM = TK6280 MT6280 MT6571 MT6572 MT6582 MT6592
ifdef PLATFORM
...
2G_TX_POWER_CONTROL_SUPPORT_PLATFORM = MT6575 MT6577 MT6280 MT6589 MT6571 MT6572 MT6582 MT6592
...
32K_CRYSTAL_REMOVAL_SUPPORT_PLATFORM = MT6280 MT6589 MT6571 MT6572 MT6582 MT6571 MT6592
QUERY_32K_CRYSTAL_FROM_MD_PLATFORM = MT6280
QUERY_32K_CRYSTAL_FROM_AP_PLATFORM = MT6589 MT6571 MT6572 MT6582 MT6571 MT6592
