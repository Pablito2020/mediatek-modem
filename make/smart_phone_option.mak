...
ifdef SMART_PHONE_CORE
  ...
  ifeq ($(strip $(SMART_PHONE_CORE)),ANDROID_MODEM)
    ...
    BLUETOOTH_SCO_SW_CODEC_PLATFORM = MT6592 MT6582 MT6571 MT6572

    ifneq ($(filter $(strip $(BLUETOOTH_SCO_SW_CODEC_PLATFORM)),$(strip $(PLATFORM))),)
      COM_DEFS +=  __BT_SCO_CODEC_SUPPORT__
      COM_DEFS +=  __CVSD_CODEC_SUPPORT__
      COMPOBJS += driver/audio/lib/MTKGCC/libcvsd_codec.a
      CUS_REL_OBJ_LIST += driver/audio/lib/MTKGCC/libcvsd_codec.a
      COMPOBJS += driver/audio/lib/MTKGCC/libmsbc_codec.a
      CUS_REL_OBJ_LIST += driver/audio/lib/MTKGCC/libmsbc_codec.a
    endif
  endif
